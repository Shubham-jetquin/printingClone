...
const header = () => {
    ...
    return <>
        ...
        >
            ...
            >
                <div
                    className={`overlay-screen js-nav__overlay-screen ${isOpenMenu ? "s-visible" : ""}`}
                    data-component-name="nav-overlay-screen"
                />
                <div className="wrapper header__wrapper u-position-relative">
                    <div className="nav-main__dropdown-background js-nav__dropdown-bg" />
                    <header className="header js-header" data-qa-name="header">
                        ...
                        <div
                            ...
                            style={isOpenMenu ? { marginRight: "0px" } : {}}
                        >
                            <button type="button">
                                <svg
                                    viewBox="0 0 48 48"
                        ...
                        {isOpenMenu &&
                            <div className="nav-main js-nav">
                                <div
                                    className="nav-main__scroll-wrap js-nav__scroll-wrap"
                                    style={{ bottom: "168.172px" }}
                                >
                                    <nav
                                   ...
                                   is-parent"
                                                    ...
                                                    <ul
                                                        className="nav-main__list -l2 js-nav__list--l2"
                                                                    ...
                                                                    >
                                                                        <div className="tile__body" data-qa-name="body">
                                                                                        ...
                                                                                        >
                                                                                            <figure className="tile__figure u-margin-0">
                                                                                                <picture>
                                                                                                    ...
                                                                                                    <img
                                                                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                                                                        data-srcset="/.imaging/scale/dam/6a173783-f415-4798-bf18-0d804246be61/0687WF-TR-752x376-Tape-Bound-Notebooks.jpg, /dam/jcr:651c18ed-4f56-43c5-9a31-ed289b6b95ff/0687WF-TR-752x376-Tape-Bound-Notebooks.jpg 2x"
                                                                                                        alt="Tape Bound Notebooks"
                                                                                                        title="Tape Bound Notebooks"
                                                                                                        className="tile__image ls-is-cached lazyloaded"
                                                                                                        data-qa-name="image"
                                                                                                        srcSet="/.imaging/scale/dam/6a173783-f415-4798-bf18-0d804246be61/0687WF-TR-752x376-Tape-Bound-Notebooks.jpg, /dam/jcr:651c18ed-4f56-43c5-9a31-ed289b6b95ff/0687WF-TR-752x376-Tape-Bound-Notebooks.jpg 2x"
                                                                                                    />
                                                                                                </picture>
                                                                                                <figcaption className="u-visually-hidden">
                                                                                                    Tape Bound Notebooks
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <div className="list-default__parent u-last-child-margin-bottom-0">
                                                                                        <p>
                                                                                            A simple, premium Notebook – with a
                                                                                            bookcloth spine for added
                                                                                            ‘oooh!’.&nbsp;Available in three sizes –
                                                                                            from Mini, Medium to Large.
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                <div className="cta-link -has-chevron">
                                                                                    <span className="cta-link__text">
                                                                                        <span>Shop Tape Bound Notebooks</span>
                                                                                        &nbsp;
                                                                                        <svg
                                                                                            viewBox="0 0 48 48"
                                                                                            className="svg-icon cta-link__chevron"
                                    ...
                                    <nav className="nav-main__nav -tools js-nav__nav--tools has-fouc">
                                        ...
                                        >
                                            ...
                                            <li className="nav-main__item -l1 -tools -country js-nav__item--country">
                                                <a
                                                    href="/us/"
                                                    className="nav-main__link -l1 -tools -country is-parent js-nav__link--country"
                                                ...
                                                <ul
                                                    ...
                                                    className="nav-main__list -l2 -tools js-nav__list--l2 js-nav__list--country"
                                            ...
                                            <li className="nav-main__item -l1 -tools js-nav__item--account">
                                                <a
                                                    href="/us/account/"
                                                    className="nav-main__link -l1 -tools -account is-parent js-nav__link--account"
                                                ...
                                                <ul
                                                    className="nav-main__list -l2 -tools js-nav__list--l2 js-nav__list--account"
